...
def main():
    st.set_page_config(page_title="Dashboard con los precios de Bitcoin", layout="wide")
    st.title("📊 Dashboard de Preços do Bitcoin")
    st.write(" El Dashboard muestra los datos del precio de Bitcoin recopilados periódicamente en una base de datos PostgreSQL.")
